...
the factory quarterly figures since launched, for session-to-order conversion rate, revenue per order, and revenue per session. 
...
/*
4. overall session-to-order conversion rate trends , by quarter. 
*/
...
/*
5. monthly trending. 
revenue and margin by product, along with total sales and revenue. Note anything you notice about seasonality.
*/
...
/*
6. new products.  
monthly sessions to the /products page, and how the % of those sessions clicking through another page has changed 
...
DROP TABLE IF EXISTS products_pageviews;
CREATE TEMPORARY TABLE products_pageviews
SELECT
	website_session_id, 
    website_pageview_id, 
